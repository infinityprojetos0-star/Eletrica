/** Catálogo e helpers (domínio/dados). */
/**
 ...
 */
export const PRECO_FONTE = "Tabela Engehall 2026 + varejo (materiais)";
...
export const SEED_PRODUTOS = [
  ...
  {
    id: "prd-23",
    nome: "Conector Wago (pct c/ 50) — misto",
    categoria: "Consumíveis",
    unidade: "pct",
    preco: 42,
    precoMin: 32,
    precoMax: 65,
    marca: "Wago / similar",
    descricao: "Pacote misto (legado).",
    icon: "consumivel",
    cor: "#ff9800"
  },
  {
    id: "prd-wago-2",
    nome: "Conector Wago 2 pólos",
    categoria: "Consumíveis",
    unidade: "un",
    preco: 1.2,
    precoMin: 0.8,
    precoMax: 2.2,
    marca: "Wago 221 / similar",
    descricao: "Emenda de 2 vias (cabo↔dispositivo).",
    icon: "consumivel",
    cor: "#ff9800"
  },
  {
    id: "prd-wago-3",
    nome: "Conector Wago 3 pólos",
    categoria: "Consumíveis",
    unidade: "un",
    preco: 1.6,
    precoMin: 1.1,
    precoMax: 2.8,
    marca: "Wago 221 / similar",
    descricao: "Derivação em T (3 vias).",
    icon: "consumivel",
    cor: "#ff9800"
  },
  {
    id: "prd-wago-5",
    nome: "Conector Wago 5 pólos",
    categoria: "Consumíveis",
    unidade: "un",
    preco: 2.4,
    precoMin: 1.6,
    precoMax: 4,
    marca: "Wago 221 / similar",
    descricao: "Junção com 4–5 vias.",
    icon: "consumivel",
    cor: "#ff9800"
  },
  {
    id: "prd-wago-10",
    nome: "Conector Wago 10 pólos",
    categoria: "Consumíveis",
    unidade: "un",
    preco: 4.9,
    precoMin: 3.5,
...
export const SEED_EMISSORES_NF = [
  {
    id: "nf-propria",
    nome: "Minha empresa",
...
export function faixaPreco(item) {
...
export function custoOcultoGlobal(state) {
...
export const SEED_DESPESAS_SERVICO = [
