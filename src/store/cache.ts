...
export { deviceId, hydrate, getState, setState, getPending, setPending, queuePatch, clearPatches, scrubPending, sanitizeFirebase, getMeta, setMeta };
export const DataCache = { deviceId, hydrate, getState, setState, getPending, setPending, queuePatch, clearPatches, scrubPending, sanitizeFirebase, getMeta, setMeta };
