...
export { CAMPOS, PRESETS, LIMITES, criarComodo, somarPontos, estimarCircuitos, calcular };
export const PreProjeto = { CAMPOS, PRESETS, LIMITES, criarComodo, somarPontos, estimarCircuitos, calcular };
